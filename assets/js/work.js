document.addEventListener("DOMContentLoaded", () => {
    ...
    const stickySection = document.querySelector(".best-project-sticky");
    const stickyHeight = window.innerHeight * 5;
    const outlineCanvas = document.querySelector(".best-project-outline-layer");
    const fillCanvas = document.querySelector(".best-project-fill-layer");
    ...
    ScrollTrigger.create({
        ...
        onUpdate: (self) => {
            ...
            const cards = document.querySelector(".best-project-cards");
